<template>
  <div class="addressTable">
    <div class="header">
      ...
      <div class="page fr">
        <el-input size="mini" placeholder="查找通讯录..." suffix-icon="el-icon-search" v-model="searchFriend"></el-input>
      </div>
    </div>
    <table>
      <thead>
    ...
    <p v-if="!list.length" class="no-address-list">通信录是空的</p>
